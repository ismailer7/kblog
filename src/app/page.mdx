...
- Visit the Binance Website: Go to Binance.com.
...
<div class="ontainer py-5 px-5 mx-0 min-w-full flex flex-col items-center"><Button arrow className="animate-bounce"> Get Started </Button></div>
