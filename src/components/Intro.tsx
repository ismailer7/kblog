  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        This is Kim Dynamic Day-to-Day Article{' '} <br />
        <span className="text-sky-300">for Crypto Miners</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
       Welcome to My One Page Blog where each day I publish an interesting article related to Crypto Currencies and how you can Buy and Sell them from different platforms.
       Hope you are going to enjoy this and looking forward to send exciting articles.
      </p>
      <SignUpForm />
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline text-[0.8125rem]/6 text-gray-500">
      Made with Love{' '}
